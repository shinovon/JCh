...
public class AttributeTable {
    ...
    */
    ...
    new Attribute( "action",           Dict.VERS_ALL,               new Object() ),
    new Attribute( "add_date",         Dict.VERS_NETSCAPE,          null ),     /* A */
    new Attribute( "align",            Dict.VERS_ALL,               null ),    /* set varies with element */
    ...
    new Attribute( "background",       Dict.VERS_LOOSE,             new Object() ),
    ...
    new Attribute( "border",           Dict.VERS_ALL,               null ),   /* like LENGTH + "border" */
    ...
    new Attribute( "checked",          Dict.VERS_ALL,               null ),     /* i.e. "checked" or absent */
    new Attribute( "cite",             Dict.VERS_HTML40,            new Object() ),
    new Attribute( "class",            Dict.VERS_HTML40,            null ),
    new Attribute( "classid",          Dict.VERS_HTML40,            new Object() ),
    new Attribute( "clear",            Dict.VERS_LOOSE,             null ),    /* BR: left, right, all */
    new Attribute( "code",             Dict.VERS_LOOSE,             null ),     /* APPLET */
    new Attribute( "codebase",         Dict.VERS_HTML40,            new Object() ),      /* OBJECT */
    ...
    new Attribute( "compact",          Dict.VERS_ALL,               null ),     /* lists */
    new Attribute( "content",          Dict.VERS_ALL,               null ),     /* META */
    new Attribute( "coords",           Dict.VERS_FROM32,            null ),   /* AREA, A */    
    new Attribute( "data",             Dict.VERS_HTML40,            new Object() ),      /* OBJECT */
    ...
    new Attribute( "datasrc",          Dict.VERS_MICROSOFT,         new Object() ),      /* used on TABLE */
    new Attribute( "datetime",         Dict.VERS_HTML40,            null ),     /* INS, DEL */
    new Attribute( "declare",          Dict.VERS_HTML40,            null ),     /* OBJECT */
    new Attribute( "defer",            Dict.VERS_HTML40,            null ),     /* SCRIPT */
    new Attribute( "dir",              Dict.VERS_HTML40,            null ),  /* ltr or rtl */
    new Attribute( "disabled",         Dict.VERS_HTML40,            null ),     /* form fields */
    ...
    new Attribute( "id",               Dict.VERS_HTML40,            null ),
    new Attribute( "ismap",            Dict.VERS_ALL,               null ),     /* IMG */
    ...
    new Attribute( "longdesc",         Dict.VERS_HTML40,            new Object() ),      /* IMG */
    new Attribute( "lowsrc",           Dict.VERS_PROPRIETARY,       new Object() ),      /* IMG */
    ...
    new Attribute( "multiple",         Dict.VERS_ALL,               null ),     /* SELECT */
    new Attribute( "name",             Dict.VERS_ALL,               null ),
    new Attribute( "nohref",           Dict.VERS_FROM32,            null ),     /* AREA */
    new Attribute( "noresize",         Dict.VERS_FRAMES,            null ),     /* FRAME */
    new Attribute( "noshade",          Dict.VERS_LOOSE,             null ),     /* HR */
    new Attribute( "nowrap",           Dict.VERS_LOOSE,             null ),     /* table cells */
    new Attribute( "object",           Dict.VERS_HTML40_LOOSE,      null ),     /* APPLET */
    new Attribute( "onblur",           Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onchange",         Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onclick",          Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "ondblclick",       Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onkeydown",        Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onkeypress",       Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onkeyup",          Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onload",           Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onmousedown",      Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onmousemove",      Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onmouseout",       Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onmouseover",      Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onmouseup",        Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onsubmit",         Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onreset",          Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onselect",         Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onunload",         Dict.VERS_HTML40,            null ),   /* event */
    new Attribute( "onafterupdate",    Dict.VERS_MICROSOFT,         null ),   /* form fields */
    new Attribute( "onbeforeupdate",   Dict.VERS_MICROSOFT,         null ),   /* form fields */
    new Attribute( "onerrorupdate",    Dict.VERS_MICROSOFT,         null ),   /* form fields */
    new Attribute( "onrowenter",       Dict.VERS_MICROSOFT,         null ),   /* form fields */
    new Attribute( "onrowexit",        Dict.VERS_MICROSOFT,         null ),   /* form fields */
    new Attribute( "onbeforeunload",   Dict.VERS_MICROSOFT,         null ),   /* form fields */
    new Attribute( "ondatasetchanged", Dict.VERS_MICROSOFT,         null ),   /* object, applet */
    new Attribute( "ondataavailable",  Dict.VERS_MICROSOFT,         null ),   /* object, applet */
    new Attribute( "ondatasetcomplete",Dict.VERS_MICROSOFT,         null ),   /* object, applet */
    new Attribute( "profile",          Dict.VERS_HTML40,            new Object() ),      /* HEAD */
    new Attribute( "prompt",           Dict.VERS_LOOSE,             null ),     /* ISINDEX */
    new Attribute( "readonly",         Dict.VERS_HTML40,            null ),     /* form fields */
    ...
    new Attribute( "selected",         Dict.VERS_ALL,               null ),     /* OPTION */
    new Attribute( "shape",            Dict.VERS_FROM32,            null ),    /* AREA, A */
    new Attribute( "showgrid",         Dict.VERS_PROPRIETARY,       null ),     /* TABLE Adobe golive */
    new Attribute( "showgridx",        Dict.VERS_PROPRIETARY,       null ),     /* TABLE Adobe golive*/
    new Attribute( "showgridy",        Dict.VERS_PROPRIETARY,       null ),     /* TABLE Adobe golive*/
    new Attribute( "size",             Dict.VERS_LOOSE,             null ),   /* HR, FONT, BASEFONT, SELECT */
    new Attribute( "span",             Dict.VERS_HTML40,            null ),   /* COL, COLGROUP */
    new Attribute( "src",              (short)(Dict.VERS_ALL | Dict.VERS_FRAMES), new Object() ),      /* IMG, FRAME, IFRAME */
    ...
    new Attribute( "usemap",           Dict.VERS_ALL,               null ),     /* things with images */
    new Attribute( "valign",           Dict.VERS_FROM32,            null ),
